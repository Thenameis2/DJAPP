...
`music-like-48k.wav` is a deterministic 20-second original synthesis fixture with drums, bass, chord tones, a changing lead, stereo movement, and non-periodic section markers. It is intended for tempo, repetition, waveform, and future rhythm-analysis diagnostics; it contains no third-party recording or composition.
...
cargo run --bin generate_music_fixture
ffmpeg -y -i tests/fixtures/audio/music-like-48k.wav -c:a libmp3lame -q:a 3 tests/fixtures/audio/music-like-48k.mp3
ffmpeg -y -i tests/fixtures/audio/music-like-48k.wav -c:a aac -b:a 160k tests/fixtures/audio/music-like-48k.m4a
```
